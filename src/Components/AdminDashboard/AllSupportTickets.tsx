...
export const AllSupportTickets = () => {
  ...
  const tickets = useMemo(() => {
    return Array.isArray(ticketsResponse)
      ? ticketsResponse
      : ticketsResponse?.data || ticketsResponse?.tickets || [];
  }, [ticketsResponse]);
                        ...
                        <td className="py-3 px-4 min-w-[180px] max-w-[260px] align-top">
                          <div className="flex flex-wrap items-center gap-1 min-w-0">
                            <button
                              ...
                              className={`inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors truncate max-w-[120px] ${
                                hasUnreadMessages(ticket)
                              ...
                              {hasUnreadMessages(ticket) ? (
                                <>
                                  ...
                                  {getUnreadMessageCount(ticket) > 0 && (
                                    <span className="ml-1 bg-white text-orange-600 text-xs px-1.5 py-0.5 rounded-full font-bold truncate">
                            ...
                            {ticket.supportTicketStatus === "Open" && (
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-2 py-1 text-xs text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors border border-blue-200 truncate max-w-[90px]"
                            ...
                            {(ticket.supportTicketStatus === "Open" ||
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-2 py-1 text-xs text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg transition-colors border border-green-200 truncate max-w-[90px]"
                            ...
                            {ticket.supportTicketStatus === "Resolved" && (
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-2 py-1 text-xs text-gray-600 hover:text-gray-700 hover:bg-gray-50 rounded-lg transition-colors border border-gray-200 truncate max-w-[90px]"
                                title="Close Ticket"
                                disabled={isUpdatingStatus}
                              >
                                <XCircle size={12} />
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
                      ...
                      {ticket.supportTicketStatus === "Resolved" && (
                        <button
                          onClick={() => handleMarkAsClosed(ticket)}
                          className="flex items-center gap-1 px-3 py-1.5 text-xs text-gray-600 hover:text-gray-700 hover:bg-gray-50 rounded-lg transition-colors flex-1 justify-center border border-gray-200"
                          disabled={isUpdatingStatus}
                        >
                          <XCircle size={12} />
                          Close
        ...
        <div className="fixed inset-0 backdrop-blur-sm bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-hidden flex">
              ...
              <div className="w-1/3 border-r border-gray-200 p-4 sm:p-6 overflow-y-auto">
